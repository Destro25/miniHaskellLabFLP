...
--ori ca aici ori doar fara token, altfel oriunde folosesc token ar trb sa fac Token. : "import qualified Text.Parsec.Token as Token"
...
--testParse replCommand ":l restanta.dragon"